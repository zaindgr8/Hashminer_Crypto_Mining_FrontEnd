        ...
        <div className="p-[10vh]">
          <form>
            <div className="flex flex-col gap-y-4">
              <div>
                ...
                <div className="relative">
                  <input
                    type="text"
                    id="first_name"
                    className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg block w-full p-2.5 pl-10 "
              ...
              <h3 className="text-sm">Deposit Gateway</h3>
              <Dropdown />
              {/* ... other input fields ... */}
            </div>
            ...
            <div className="flex flex-col items-start mb-6 mt-5">
              ...
              <span className="text-sm flex gap-x-2 items-center">
                <IoIosAlert />
                Minimum Deposit can be $100 USD
              </span>
              <span className="text-sm flex gap-x-2 items-center">
                <IoIosAlert />
                $10 FREE Bonus on registration
              </span>
              <div>
            ...
            <button
              type="submit"
              className="text-white bg-green-700 hover:bg-blue-500 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center"
            >
              Submit
            </button>
          </form>
