    ...
    <div className="details">
      ...
      <div className="detail_page_main">
        ...
        <form className="px-[8vh] py-[5vh] font-bold text-blue-500">
          <div className="mb-6">
            <h1 className="text-4xl mb-5">Login Password</h1>
            <label
              htmlFor="email"
          ...
          <div className="mb-6">
            ...
            <input
              ...
              required
            />
            <button className='text-red-500 cursor-pointer p-1 rounded-lg mt-2 border-red-500 hover:text-blue-500 hover:border-blue-500 border-2'>Get OTP</button>
          </div>
